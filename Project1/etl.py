...
def process_song_file(cur, filepath):
    """
    This will process a song in a given file and load it to the PostgreSQL 
    database.
    """
    # open song file
...
def process_log_file(cur, filepath):
    """
    This will process a given log and 
    load it to the PostgreSQL database
    """
    # open log file
...
def process_data(cur, conn, filepath, func):
    """
    This will process each data file in a
    file path using func
    """
...
def main():
    """
    Main function that will process the
